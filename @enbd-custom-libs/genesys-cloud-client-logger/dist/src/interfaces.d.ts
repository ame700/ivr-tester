...
export declare type NextFn = NextFnWithoutParams & NextFnWithParams;
export declare type NextFnWithoutParams = () => void;
export declare type NextFnWithParams = (level: LogLevel, message: string | Error, details?: any, options?: ILogMessageOptions) => void;
export declare type LogFormatterFn = (level: LogLevel, message: string | Error, details: any | undefined, options: ILogMessageOptions, next: NextFn) => void;
