...
export const mediaStreamRecorderPlugin = (config: Config | GenesysConfig): IvrTesterPlugin => {
...
export class MediaStreamRecorder {
  private static readonly FILE_EXT = "pcm";
  ...
  private writeToFile(data: Buffer): void {
    this.writeStream.write(alawmulaw.mulaw.decode(data)); // convert to PCM 16bit 8KHz , 1 channel mono
  }
