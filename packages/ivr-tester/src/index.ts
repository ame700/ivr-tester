import { CallingServiceType } from "./call/Call";
...
export * from "./call/transcription/plugin/SynthesizerPlugin";
export * from "./call/transcription/plugin/SynthesizerFactory";


export { Scenario } from "./configuration/scenario/Scenario";
export { PluginManager } from "./plugins/PluginManager";
export { IvrNumber } from "./configuration/call/IvrNumber";
export { CallingServiceType } from "./call/Call";